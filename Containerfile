...
RUN dnf5 install vlc vim neovim git curl wget i3 i3lock i3status python3-i3ipc rofi dmenu feh nitrogen variety volumeicon pasystray tlp tlp-rdw ranger
