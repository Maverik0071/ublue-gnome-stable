...
RUN dnf5 install vlc vim neovim git curl wget i3 i3lock i3status python3-i3ipc rofi dmenu feh nitrogenfedora-release-i3 variety volumeicon pasystray network-mananger-applet NetworkManager tlp tlp-rdw
